...
// Add the button in the JSX, next to the Download JSON button
<button
  onClick={handleDownloadMarkdown}
  className="p-2 bg-white border border-gray-200 rounded-lg hover:bg-gray-50"
  title="Download Markdown Report"
>
  <Download className="w-5 h-5 text-gray-600" /> {/* You can use a different icon if needed, e.g., FileText */}
</button>
...
// Add the button in the JSX, next to the other buttons
<button
...
<button
  ...
  title="Print Report"
>
  <Printer className="w-5 h-5 text-gray-600" /> {/* Import Printer from lucide-react if not already */}
</button>
